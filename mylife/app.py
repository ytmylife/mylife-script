...
@app.route('/addssh', methods=['GET'])

@app.route('/addvmess', methods=['GET'])

@app.route('/addvless', methods=['GET'])

@app.route('/addshadowsocks', methods=['GET'])

@app.route('/addsocks', methods=['GET'])
